...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
            new RecyclerViewItemClickListener.OnItemClickListener() {
              ...
              public void onItemClick(View v, int position) {
                ...
                Intent i = new Intent(MyStocksActivity.this, MyStocksDetailActivity.class);
                i.putExtra("id", id);
                startActivity(i);
    ...
    FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
      ...
      public void onClick(View v) {
        if (isConnected()) {
          new MaterialDialog.Builder(mContext).title(R.string.new_search)
                  ...
                  .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                      ...
                      public void onInput(MaterialDialog dialog, CharSequence input) {
                          ...
                          if (c.getCount() != 0) {
                              Snackbar snackbar =
                                      Snackbar.make(findViewById(R.id.rlay), getText(R.string.saved_stock), Snackbar.LENGTH_LONG);
                              snackbar.show();
                              return;
                          } else {
  ...
  private void checkCursorAdapter() {
    if (isConnected()) {
      ...
      if (mCursorAdapter.getItemCount() == 0) {
        ...
        message.setVisibility(View.INVISIBLE);
          Snackbar snackbar =
                  Snackbar.make(findViewById(R.id.rlay), getText(R.string.old_data), Snackbar.LENGTH_LONG);
          snackbar.show();
      }
    }
  }
  ...
  public void networkError() {
    Snackbar snackbar = Snackbar.make(findViewById(R.id.rlay), getText(R.string.no_network), Snackbar.LENGTH_LONG)
